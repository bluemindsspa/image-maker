...
class AccountMove(models.Model):
    ...
    def create_factoring_document(self):
        ...
        signed_dte = base64.b64decode(self.l10n_cl_dte_file.datas).decode('ISO-8859-1').replace(
        ...
        signed_dte = self._sign_full_xml_cesion(
            dte, digital_signature, doc_id_number, 'dte_cedido',
    ...
    def _l10n_cl_create_dte_cesion(self):
        ...
        dte_cesion = self._sign_full_xml(
            dte_cesion, digital_signature, doc_id_number, 'aec',
            self.l10n_latam_document_type_id._is_doc_type_voucher())
